    ...
    */
    ...
    initLevels: function(path) {  // ensure valid {{site.baseurl}} for path
        ...
        const zombieApocolypse = [
          ...
          { name: 'brain', id: 'brain', class: Brain, data: this.assets.enemies.brain, xPercentage: 0.2, minPosition: 0.05},
          ...
          { name: 'brain', id: 'brain', class: Brain, data: this.assets.enemies.brain, xPercentage:  0.7, minPosition: 0.1 },
